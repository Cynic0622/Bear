...
namespace Bear {
	...
	// 定义静态成员变量
	const std::vector<const char*> VulkanValidation::Layers = {
		"VK_LAYER_KHRONOS_validation"
	};
	VulkanValidation::VulkanValidation(VkInstance instance)
	{
		m_Instance = instance;
...
#ifdef BEAR_DEBUG
		BEAR_CORE_INFO("BEAR::VulkanValidation : Vulkan Debug Messenger created.");
#endif // BEAR_DEBUG
	...
	bool VulkanValidation::CheckSupport()
	{
		uint32_t layerCount;
	...
	VkResult VulkanValidation::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo,
