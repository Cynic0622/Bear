...
namespace Bear {
    ...
    inline VkDescriptorType ToVulkanDescriptorType(Bear::DescriptorType type) {
        switch (type) {
    ...
    inline VkShaderStageFlags ToVulkanShaderStage(Bear::ShaderStage stage) {
    ...
    inline VkBufferUsageFlags ToVulkanBufferUsage(Bear::BufferUsage usage) {
    ...
    inline VkPrimitiveTopology ToVulkanTopology(PrimitiveTopology topology) {
        switch (topology) {
    ...
    inline VkPolygonMode ToVulkanPolygonMode(PolygonMode mode) {
        switch (mode) {
    ...
    inline VkFrontFace ToVulkanFrontFace(FrontFace face) {
        switch (face) {
    ...
    inline VkAttachmentLoadOp ToVulkanLoadOp(AttachmentLoadOp op) {
        switch (op) {
    ...
    inline VkAttachmentStoreOp ToVulkanStoreOp(AttachmentStoreOp op) {
        switch (op) {
    ...
    inline VkImageLayout ToVulkanImageLayout(ImageLayout layout) {
        switch (layout) {
    ...
    inline VkFormat ToVulkanFormat(PixelFormat format) {
        switch (format) {
	...
	class VulkanDevice;
    inline VkFormat FindDepthFormat(const VulkanDevice& device)
    {
