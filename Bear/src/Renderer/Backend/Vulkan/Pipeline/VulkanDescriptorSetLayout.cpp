...
namespace Bear {
	VulkanDescriptorSetLayout::VulkanDescriptorSetLayout(const VulkanDevice& device, const std::vector<VkDescriptorSetLayoutBinding>& bindings)
		:m_Device(device)
	{
		// 7/29/2025
	...
	VkDescriptorType VulkanDescriptorSetLayout::GetDescriptorType(uint32_t binding) const
	{
		// 查询绑定的描述符类型
