...
namespace Bear {
	...
	public:
		...
		void End() override;
		void Reset();
		void BeginRenderPass(RHIRenderPass* rhiRenderPass, void* rhiFramebuffer, uint32_t width, uint32_t height, const std::vector<RHIClearValue>& clearValues) override;
